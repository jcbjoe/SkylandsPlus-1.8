...
private void shapeLand(org.bukkit.World world, int chunkX, int chunkZ, byte[] blocks)
  {
    ...
    this.q = a(this.q, chunkX * b0, 0, chunkZ * b0, k, l, i1);
    byte blockType;
    switch (world.getEnvironment())
    {
    case NETHER: 
  ...
  @SuppressWarnings("deprecation")
private void decorateLand(int chunkX, int chunkZ, byte[] blocks, ChunkGenerator.BiomeGrid biomes)
  {
    double d0 = 0.03125D;
  ...
  public byte[][] generateBlockSections(org.bukkit.World world, Random random, int chunkX, int chunkZ, ChunkGenerator.BiomeGrid biomes)
  {
    ...
    shapeLand(world, chunkX, chunkZ, blocks);
    if (environment == World.Environment.NORMAL)
    {
      this.caveGen.a(mcWorld.N(), mcWorld, chunkX, chunkZ, snap);
    }
    else if (environment == World.Environment.NETHER)
    {
      this.caveGenNether.a(mcWorld.N(), mcWorld, chunkX, chunkZ, snap);
      this.genNetherFort.a(mcWorld.N(), mcWorld, chunkX, chunkZ, snap);
    }
    decorateLand(chunkX, chunkZ, blocks, biomes);
